...
# Bot information
SESSION = environ.get('SESSION', 'DKFilter')
API_ID = int(environ.get('API_ID', '29489981'))
API_HASH = environ.get('API_HASH', 'd06d320353dd369c577b33be893c622b')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5297888360 921817729').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002356825750'))
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002356825750')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002279756242')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dknabeel413:LGhRwvPnJIEdDCIV@cluster0.hvceh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'dkcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_2024_Hub')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Anime_Maniaq')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Hub_Supportz') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/RoronoaZo0ro')
